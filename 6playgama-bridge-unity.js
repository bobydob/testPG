...
bridgeScript.src = 'https://cdn.jsdelivr.net/gh/bobydob/testPG@main/3playgama-bridge.js'
...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'https://cdn.jsdelivr.net/gh/bobydob/testPG@main/Build.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'https://cdn.jsdelivr.net/gh/bobydob/testPG@main/Build.data.unityweb',
                        frameworkUrl: 'https://cdn.jsdelivr.net/gh/bobydob/testPG@main/Build.framework.js.unityweb',
                        codeUrl: 'https://cdn.jsdelivr.net/gh/bobydob/testPG@main/Build.wasm.unityweb',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'GameVGames',
                        productName: 'Snow Rush 3D',
                        productVersion: '1.0',
...
// --- ПРЯМОЙ ВЗЛОМ UNITY (В обход всех проверок Playgama и Google) ---
window.forceUnlockUnity = function(adType) {
    console.log("💥 ПРЯМОЙ ВЫСТРЕЛ В C# UNITY: " + adType);
    let eventName = adType === 'rewarded' ? 'OnRewardedStateChanged' : 'OnInterstitialStateChanged';
    
    // Бьем напрямую в движок, игнорируя origin
    sendMessageToUnity(eventName, 'closed');
    sendMessageToUnity(eventName, 'close'); // Дублируем формат на всякий случай
};